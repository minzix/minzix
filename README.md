...
- **이름:** 김민지  
- **학교:** 숙명여자대학교 IT공학부 22학번 (4학년 1학기 휴학 중)  
- **생년월일:** 2003.04.19  
...
|--------|----------|------------|------------|--------------|
| Codeit PowerBoost 1기 | 동아리 | 백엔드 개발 | 2024.04.01 ~ 2025.02.15 | [수료증 보기](https://minzix.github.io/minzix/certificates/숙명여대_PB_BE_김민지_수료증.pdf) |
| 구름톤 유니브 숙명여대 3기 | 동아리 | 프론트엔드 개발 | 2024.09.01 ~ 2025.01.01 | [수료증 보기](https://minzix.github.io/minzix/certificates/구름톤유니브_FE_김민지_수료증.pdf) |
| IT’s U | 동아리 | 카드뉴스 제작, 홈페이지 모니터링 | 2024.03.01 ~ 2025.01.01 | [수료증 보기](https://minzix.github.io/minzix/certificates/IT'sU_리더십그룹_부원_김민지_수료증.pdf) |
| WIN | 학회 | IT공학부 연구성과 기사 작성, 카드뉴스 제작 | 2024.03.01 ~ 2025.02.01 | [수료증 보기](https://minzix.github.io/minzix/certificates/WIN_웹운영팀_부원_김민지_수료증.pdf) |
...
| 종목/등급 | 합격일자 | 유효기간 | 자격증 링크 |
|-----------|-----------|-----------|---------------|
| 제54회 SQL 개발자(SQLD) | 2024.09.20 | 2024.09.20 ~ 2026.09.20 | - |


## Projects

| 프로젝트 명 | 진행 기한 | 역할 | 설명 및 배운 점 | 배포 링크 |
|--------------|----------------------------|-------------------|----------------|-------------|
| Codable | 2024.01.09 ~ 2024.02.05 | 프론트엔드 개발 | 알고리즘 스터디용 Web IDE. 로그인 후 팀원들과 정해둔 제한 시간에 맞추어 문제 풀이 후 채팅으로 회고까지 가능한 구조. React 기반으로 카카오 로그인 페이지 및 메인 페이지 제작, Axios instance, reset CSS 등 실무적인 지식 습득. | [배포 링크](https://example.com) |
| Klay | 2024.11.18 ~ 2024.11.23 | 프론트엔드 개발 | 외국인 유학생들을 위한 미션 기반 소통 플랫폼. 카카오 로그인 및 미션별 댓글 기능 구현. React로 페이지 제작, 쿼리 파라미터 방식으로 API 연동. | [배포 링크](https://example.com) |
| 아보행 | 2025.01.05 ~ 2025.02.15 | 백엔드 개발 | 일상 속 행복 기록 및 공유 서비스. Google Drive 백업 API 구현, Express 기반 서버와 MySQL 연동, OAuth 인증 처리. | [배포 링크](https://example.com) |
