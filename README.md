...
<a href="#"><img src="https://img.shields.io/badge/Spring-6DB33F?logo=spring&logoColor=white" height="22" /></a>
...
|-------------|------------|------|----------------|----------|
| 예시 프로젝트 | 2024.07 ~ 2024.08 | 프론트엔드 개발 | React와 REST API를 활용한 CRUD 구현, 상태관리 학습 | [배포 링크](https://example.com) |
| 예시 프로젝트2 | 2024.09 ~ 2024.10 | 백엔드 개발 | SpringBoot와 MySQL로 회원가입 및 로그인 기능 구현 | - |
...
|--------|------|------------|------------|--------------|
| UMC 8기 | 개발 동아리 | 백엔드 개발자 | 2024.03 ~ 2024.07 | [수료증 보기](https://example.com/cert.pdf) |
| AWS 온라인 캠프 | 교육 프로그램 | 수강생 | 2023.12 ~ 2024.01 | [수료증 보기](https://example.com/aws.pdf) |
