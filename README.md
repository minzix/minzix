...
|-------------|------------|------|----------------|----------|
| Codable | 2024.01.09 ~ 2024.02.05 | 프론트엔드 개발 | 알고리즘 스터디용 Web IDE 제작. 로그인 후 팀원들과 시간 맞춰 문제 풀이 및 채팅까지 가능한 구조. React 기반 로그인/메인 페이지 제작, Axios instance, reset CSS 등 실무적인 지식 습득. | [배포 링크](https://example.com) |
...
| 아보행 | 2025.01.05 ~ 2025.02.15 | 백엔드 개발 | 일상 속 행복 기록 및 공유 서비스. Google Drive 백업 API 구현, Express 기반 서버와 MySQL 연동, OAuth 인증 처리 경험. | [배포 링크](https://example.com) |



## 참여한 활동 및 동아리

| 활동명 | 구분 | 맡은 역할 | 활동 기간 | 수료증 링크 |
|--------|------|------------|------------|--------------|
...
| [구름 x 인프런] 자바 스프링 & 리액트 풀스택 개발자 성장 과정 11회차 | KDT | 백엔드 개발, 프론트엔드 개발 | 2024.09.01 ~ 2025.02.28 | [수료증 보기](attachment:83c9d620-d8f1-4d67-ac6e-00df9339ec23:김민지.pdf) |
